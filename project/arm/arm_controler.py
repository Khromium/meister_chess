...
class arm:
    def __init__(self, servo0, servo1, servo2, servo3, servo4):
        ...
        self.pos_list = [[101,114, 93, 30],[ 96,113, 93, 31],[ 89,111, 93, 35],[ 82,110, 93, 40],[ 75,110, 93, 40],[ 69,111, 93, 39],[ 61,113, 93, 37],[ 58,115, 90, 35],
                        ...
                        [143, 70, 45, 86],[135, 70, 35, 90],[118, 25,  3, 75],[100, 25,  2, 85],[ 72, 25,  1, 86],[ 47, 25,  2, 84],[ 26, 25,  2, 72],[ 18, 25,  2, 55],
    ...
    def hold(self):
        for  i in [x/43 for x in range(1, 44)]:
            self.servo4.set_pos(40 + i*(83-40))
        time.sleep(0.3)
    
    def release(self):
        for  i in [x/43 for x in range(1, 44)]:
            self.servo4.set_pos(83 + i*(40-83))
        time.sleep(0.3)
